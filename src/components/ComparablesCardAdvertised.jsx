...
export default function ComparablesCardAdvertised() {
  return (
    <>
      <li className="group col-span-1 relative bg-white rounded-md shadow hover:shadow-md hover:scale-[1.015]">
        <div className="relative flex w-full bg-gray-100">
          ...
          <div className="flex flex-row w-full justify-between items-center rounded-t-md bg-amber-400 pr-3 hover:mix-blend-multiply">
            <label htmlFor="include-9" className="flex flex-1 justify-between items-center pl-3 pr-2 py-3 cursor-pointer select-none">
              <span className="inline-flex text-xs font-bold text-gray-700">Advertised</span>
        ...
        <img className="w-full saturate-50 group-hover:saturate-100 bg-gray-300" src={"./src/img/S670-4.jpeg"} alt="John Deere combine" />
