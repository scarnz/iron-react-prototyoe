...
class ChartControls extends React.Component {
  constructor(props){
    ...
    return (
      <aside id="chartControls" className="xxxbg-red-200 relative w-full flex flex-col sm:flex-row items-start md:items-center justify-start mt-3 sm:mt-[0.8125rem] mb-3">
        <div id="chartControlLabel" className="xxxabsolute flex top-0 sm:static flex xxxflex-0 items-center h-9 xxx-22 xxx-mt-11 sm:mt-0 mr-2 md:mr-3 ml-1 sm:ml-3 mb-0 sm:mb-0">
